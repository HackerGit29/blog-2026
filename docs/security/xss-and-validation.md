...
Toutes les chaînes HTML insérées via `dangerouslySetInnerHTML` passent par le module centralisé [`src/lib/sanitize.ts`](file:///c:/Users/paoss/Desktop/blog/src/lib/sanitize.ts) :
...
*   **Articles de Blog** : Le composant [`BlogArticle.tsx`](file:///c:/Users/paoss/Desktop/blog/src/pages/BlogArticle.tsx) utilise le helper `createSafeMarkup` pour injecter le corps de l'article assaini.
*   **Boîte de Réception (Inbox)** : Le composant [`MessageDrawer.tsx`](file:///c:/Users/paoss/Desktop/blog/src/components/inbox/MessageDrawer.tsx) assainit le corps du message reçu avant tout rendu.
...
Le composant [`AdminSettings.tsx`](file:///c:/Users/paoss/Desktop/blog/src/pages/admin/AdminSettings.tsx) intègre un mécanisme de vérification de disponibilité asynchrone :
